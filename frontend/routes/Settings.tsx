...
export default function Settings() {
  ...
  return (
    <section className="flex flex-col w-full h-full overflow-hidden">
      ...
      <div className="flex flex-col items-center w-full h-full overflow-y-auto pb-20">
        <div className="flex flex-col items-center justify-start w-full gap-8 pt-24 pb-44 mx-auto max-w-full">
          {/* User Profile Card */}
